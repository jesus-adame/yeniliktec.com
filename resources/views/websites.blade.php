    ...
    <div class="container mx-auto my-10">
        <div class="service">
            <div class="flex flex-wrap my-4 mx-2 items-center justify-around">
                <div class="content w-full md:w-1/2">
                    <h3 class="text-purple-900">Diseño Web</h3>
        ...
        <div class="service">
            <div class="flex flex-wrap my-4 mx-2 items-center justify-around">
                ...
                <div class="content w-full md:w-1/2">
                    <h3 class="text-purple-900">Landing Page</h3>
        ...
        <div class="service">
            <div class="flex flex-wrap my-4 mx-2 items-center justify-around">
                <div class="content w-full md:w-1/2">
                    <h3 class="text-purple-900">Páginas Web</h3>
        ...
        <div class="service">
            <div class="flex flex-wrap my-4 mx-2 items-center justify-around">
                ...
                <div class="content w-full md:w-1/2">
                    <h3 class="text-purple-900">E-commerce</h3>
        ...
        <div class="service">
            <div class="flex flex-wrap my-4 mx-2 items-center justify-around">
                <div class="content w-full md:w-1/2">
                    <h3 class="text-purple-900">Sistemas Web</h3>
                    <p class="text-xl">
